...
DEFAULT_RULES = [
    ...
    {"pattern": r"TATASKY|TATA PLAY", "type": "regex", "clean": "TATA PLAY", "category": "Utilities & Bills"},
    {"pattern": r"COLLEGE|TUITION", "type": "regex", "clean": "COLLEGE FEES", "category": "Education & Learning"},
